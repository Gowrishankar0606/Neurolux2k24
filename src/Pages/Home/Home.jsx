  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-600 ">
      <div className="w-full h-full">
        <div className='absolute top-20 md:top-40 left-0 right-0 text-center pt-4 font-bold text-2xl md:text-5xl bg-gradient-to-r from-blue-800 to-red-800 text-transparent bg-clip-text drop-shadow-[2px_-6px_2px_black]'>
          <TypeAnimation 
        ...
        <div className='absolute bottom-50 md:bottom-6 left-0 right-0 text-center'>
          <a href='./Register'>
